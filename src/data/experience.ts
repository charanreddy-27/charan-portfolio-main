const workData = [
  ...
  },
  {
    ...
    description: "Assisting GB Traders, a UK-based car trading platform, in building and executing digital marketing strategies to enhance brand presence, drive engagement, and support customer acquisition across social platforms.",
    responsibilities: [
      "Planned and executed social media campaigns tailored to the automotive industry, increasing reach and impressions organically",
      "Designed visually compelling creatives and car listings using brand-aligned assets to maintain aesthetic consistency",
      "Monitored performance metrics to refine strategies, resulting in improved CTR and audience engagement",
      "Collaborated with the marketing team to schedule promotional content despite limited access to media assets",
